...
describe('Admin Clients API', () => {
  ...
  describe('GET /api/admin/clients', () => {
    it('should return list of clients for admin', withTestTransaction(async () => {
      // Create customer
    ...
    it('should reject access for non-admin users', withTestTransaction(async () => {
    ...
    it('should filter by search term', withTestTransaction(async () => {
      await prisma.user.create({
        data: {
          id: randomUUID(),
    ...
    it('should paginate results correctly', withTestTransaction(async () => {
  ...
  describe('GET /api/admin/clients/[id]', () => {
    it('should return client details', withTestTransaction(async () => {
    ...
    it('should return 404 for non-existent client', withTestTransaction(async () => {
      mockGetServerSession.mockResolvedValue(createMockSession('ADMIN'));
