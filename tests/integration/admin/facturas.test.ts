 ...
 * 
 * API: /api/admin/facturas
 * Páginas: /admin/facturas, /admin/facturas/[id]
 */
...
describe('Sistema de Facturación - API Admin', () => {
  ...
  describe('GET /api/admin/facturas', () => {
    it('debe retornar 401 si no está autenticado', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas');
    ...
    it('debe soportar paginación', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas?page=1&limit=10', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
    ...
    it('debe permitir filtrar por fecha', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas?desde=2024-01-01&hasta=2024-12-31', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
    ...
    it('debe permitir buscar por número de factura', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas?busqueda=F-2024', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
  ...
  describe('GET /api/admin/facturas/[id]', () => {
    it('debe retornar 401 si no está autenticado', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas/test-id');
      expect(response.status).toBe(401);
    });

    it('debe retornar 404 si la factura no existe', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas/factura-inexistente', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
    ...
    it('debe retornar detalle completo de factura', async () => {
      const response = await fetch(`http://localhost:3000/api/admin/facturas/test-factura-id`, {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
  ...
  describe('GET /api/admin/facturas/[id]/pdf', () => {
    it('debe retornar 401 si no está autenticado', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas/test-id/pdf');
      expect(response.status).toBe(401);
    });

    it('debe generar PDF de la factura', async () => {
      const response = await fetch(`http://localhost:3000/api/admin/facturas/test-factura-id/pdf`, {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
  ...
  describe('DELETE /api/admin/facturas/[id]', () => {
    it('debe retornar 401 si no está autenticado', async () => {
      const response = await fetch('http://localhost:3000/api/admin/facturas/test-id', {
        method: 'DELETE',
      });
...
describe('Sistema de Facturación - Página UI', () => {
  describe('GET /admin/facturas', () => {
    it('debe cargar página de facturas', async () => {
      const response = await fetch('http://localhost:3000/admin/facturas', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
  ...
  describe('GET /admin/facturas/[id]', () => {
    it('debe cargar detalle de factura', async () => {
      const response = await fetch('http://localhost:3000/admin/facturas/test-id', {
        headers: {
          'Cookie': 'next-auth.session-token=admin-token'
        }
      });
