...
export const productTranslations: Record<string, { 
  ...
  'PROD-0001': {
    ...
    description: 'Jarrón con diseño floral para decoración del hogar. Perfecto para flores artificiales o como pieza decorativa independiente.',
    shortDescription: 'Elegante jarrón floral para decoración del hogar'
  },
  'PROD-0002': {
    name: 'Organizador de Escritorio Hexagonal',
    description: 'Organizador hexagonal modular para suministros de oficina y hogar. Cada módulo se puede combinar para crear configuraciones personalizadas.',
  ...
  'PROD-0004': {
    ...
    description: 'Soporte para teléfono inteligente con ángulo ajustable. Compatible con teléfonos de hasta 7 pulgadas. Incluye ranura para gestión de cables.',
