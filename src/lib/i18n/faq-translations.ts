...
export const faqTranslations: Record<string, { question: string; answer: string }> = {
  ...
  'FAQ-0004': {
    ...
    answer: 'Actualmente solo ofrecemos productos de nuestro catálogo fijo. Los pedidos personalizados pueden estar disponibles en el futuro.'
  },
  
  // FAQ-0005 - Care
  'FAQ-0005': {
    question: '¿Cómo debo cuidar mis artículos impresos en 3D?',
    answer: 'Mantén alejados de la luz solar directa y fuentes de calor (especialmente artículos de PLA). Limpia con un paño húmedo. Evita sumergir en agua.'
  },
  ...
  'FAQ-0007': {
    ...
    answer: 'La mayoría de nuestros productos son adecuados para niños mayores de 3 años. Consulta las descripciones individuales de productos para recomendaciones específicas de edad.'
  },
