...
export function ReviewFormClient({ productId, productName }: Readonly<ReviewFormClientProps>) {
  ...
  if (submitted) {
    return (
      <div className="text-center py-4">
        ...
        <p className="text-sm text-gray-500">Tu reseña será revisada y publicada pronto.</p>
      </div>
    );
  }
