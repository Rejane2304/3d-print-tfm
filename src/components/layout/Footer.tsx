...
const TikTokIcon = () => (
  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    <path
      d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93-2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" // eslint-disable-line max-len
    />
  </svg>
);
          ...
          <div className="lg:col-span-6">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 flex \
                  items-center justify-center hover:bg-indigo-600 \
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center \
                  hover:bg-indigo-600 transition-all duration-300 min-h-[44px] min-w-[44px]"
                aria-label="Facebook"
              >
                <FacebookIcon />
              </a>
                  ...
                  <li>
                    <Link
                      ...
                      className="text-gray-400 hover:text-white text-sm \
                        transition-colors flex items-center gap-2 group min-h-[24px]"
                    >
                      <span
                        className="w-1.5 h-1.5 bg-gray-600 \
                          rounded-full group-hover:bg-indigo-400 \
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 group min-h-[44px]">
                    <div
                      className="w-8 h-8 rounded-lg bg-white/10 flex \
