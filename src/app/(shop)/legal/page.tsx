...
import { AlertTriangle, Building2, Copyright, FileText, Globe, Mail, MapPin, Phone, Scale, Shield } from 'lucide-react';
      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 text-white">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-16 md:py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300">Información legal y condiciones de uso del sitio web</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Company Information */}
            <LegalSection title="Información de la Empresa" icon={<Building2 className="h-6 w-6" />}>
            ...
            <LegalSection title="Datos de Registro" icon={<FileText className="h-6 w-6" />}>
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Esta empresa está registrada en el Registro Mercantil de Barcelona, Tomo 12345, Folio 67, Hoja
                  B-890123, Inscripción 1ª.
                </p>
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-3">
            ...
            <LegalSection title="Propiedad Intelectual e Industrial" icon={<Copyright className="h-6 w-6" />}>
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                  Todos los contenidos de este sitio web, incluyendo pero no limitado a: textos, fotografías, gráficos,
                  imágenes, iconos, tecnología, software, enlaces y demás contenidos audiovisuales o sonoros, así como
                  su diseño gráfico y códigos fuente, son propiedad intelectual de 3D Print o de terceros que han
                  autorizado su uso.
                </p>
                <p className="leading-relaxed">
                  Queda prohibida la reproducción, distribución, comunicación pública, transformación o cualquier otro
                  uso de los contenidos de este sitio web sin el previo consentimiento expreso y por escrito de 3D
                  Print.
                </p>
                <p className="leading-relaxed">
                  Las marcas, nombres comerciales o signos distintivos que aparecen en este sitio web son propiedad de
                  3D Print o de terceros, sin que pueda entenderse que el acceso al sitio web atribuya derecho alguno
                  sobre dichas marcas.
                </p>
              </div>
            </LegalSection>
            ...
            {/* Disclaimer */}
            <LegalSection title="Exención de Responsabilidad" icon={<AlertTriangle className="h-6 w-6" />}>
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                ...
                <p className="leading-relaxed">
                  Los precios y disponibilidad de los productos pueden variar sin previo aviso. Nos esforzamos por
                  mantener la información actualizada, pero no garantizamos la ausencia de errores.
                </p>
              </div>
            </LegalSection>

            {/* Applicable Law */}
            <LegalSection title="Legislación Aplicable y Jurisdicción" icon={<Globe className="h-6 w-6" />}>
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                  El presente aviso legal se rige por la legislación española. Para la resolución de cualquier
                  controversia que pudiera derivarse del acceso o uso del sitio web, el usuario y 3D Print se someten
                  expresamente a los juzgados y tribunales de Barcelona, renunciando a cualquier otro fuero que pudiera
                  corresponderles.
                </p>
                <p className="leading-relaxed">
                  En cumplimiento de la normativa vigente, ponemos a disposición de los usuarios los siguientes textos
                  legales:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
            ...
            {/* Data Protection */}
            <LegalSection title="Protección de Datos" icon={<Shield className="h-6 w-6" />}>
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                  ...
                  personales, le informamos que los datos personales que nos proporcione serán tratados de forma
                ...
                <p className="leading-relaxed">
                  ...
                  y portabilidad de los datos dirigiéndose a través del email: privacidad@3dprint.com o por correo
                  postal a nuestra dirección fiscal.
                </p>
                <p className="leading-relaxed">
                  Para más información, consulte nuestra{' '}
                  <a href="/legal/privacy-policy" className="text-indigo-600 hover:text-indigo-800 font-medium">
                    Política de Privacidad
                  </a>{' '}
                  y nuestra{' '}
                  <a href="/legal/cookies-policy" className="text-indigo-600 hover:text-indigo-800 font-medium">
                    Política de Cookies
                  </a>
                  <span>. </span>
                </p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                  <h3 className="font-semibold text-gray-900">Documentos relacionados</h3>
                </div>
                <nav className="divide-y divide-gray-100">
                  ...
                  >
                    <span className="text-sm text-gray-700 group-hover:text-indigo-600">Términos y condiciones</span>
                  ...
                  <a
                    ...
                    className="flex items-center justify-between px-6 py-3 hover:bg-gray-50 transition-colors group"
                  >
                    <span className="text-sm text-gray-700 group-hover:text-indigo-600">Política de privacidad</span>
                    <span className="text-gray-400">→</span>
                  </a>
                  <a
                    href="/legal/cookies"
                    className="flex items-center justify-between px-6 py-3 hover:bg-gray-50 transition-colors group"
                  >
                    <span className="text-sm text-gray-700 group-hover:text-indigo-600">Política de cookies</span>
                    <span className="text-gray-400">→</span>
                  </a>
                  <button
                    type="button"
                  ...
                  >
                    <span className="text-sm text-gray-700 group-hover:text-indigo-600">Política de devoluciones</span>
                    <span className="text-gray-400">→</span>
                  </button>
                </nav>
              </div>
