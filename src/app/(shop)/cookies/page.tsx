        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 3xl:px-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg lg:text-xl text-white/80 leading-relaxed">
              Te informamos sobre qué son las cookies, qué tipos utilizamos en
              nuestra web y cómo puedes gestionarlas conforme a la normativa
              vigente.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div id="que-son">
              ...
              >
                <p className="mb-4">
                  ...
                  tu dispositivo (ordenador, tablet, móvil o cualquier otro
                  dispositivo) cuando visitas una página web. Estos archivos
                  permiten que el sitio web recuerde información sobre tu
                  visita, como tu idioma preferido, las opciones de
                  configuración seleccionadas y otros datos que facilitan tu
                  navegación y hacen que la experiencia sea más eficiente.
                </p>
                <p className="mb-4">
                  Las cookies desempeñan un papel muy importante, ya que mejoran
                  la experiencia de navegación y ayudan a que los sitios web
                  funcionen de manera más eficiente. También proporcionan
                  información valiosa a los propietarios de los sitios web para
                  mejorar sus servicios y ofrecer una experiencia más
                  personalizada.
                </p>
                <div className="bg-indigo-50 rounded-lg p-4 border-l-4 border-indigo-500">
                  <p className="text-sm text-indigo-800">
                    <strong>Importante:</strong> Las cookies no pueden dañar tu
                    dispositivo y no contienen virus ni malware. Tampoco
                    almacenan información sensible como contraseñas o datos
            ...
            <div id="tipos">
              ...
              >
                <p className="mb-4">
                  En <strong>3D Print</strong> utilizamos diferentes tipos de
                  cookies para mejorar tu experiencia de navegación. A
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        automáticamente cuando cierras el navegador.
                        <br />
                        <strong>Cookies persistentes:</strong> Permanecen en tu
                        dispositivo hasta que caducan o las eliminas
                        manualmente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        <br />
                        <strong>De preferencias:</strong> Recuerdan tus
                        configuraciones y preferencias.
                        <br />
                        <strong>Analíticas:</strong> Nos ayudan a mejorar
                        recopilando datos estadísticos.
                        <br />
                        <strong>De marketing:</strong> Permiten mostrarte
                  ...
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        <strong>Cookies propias:</strong> Instaladas por nuestro
                        sitio web.
                        <br />
                        <strong>Cookies de terceros:</strong> Instaladas por
                        servicios externos que utilizamos (análisis, pagos,
                        etc.).
                      </p>
                    </div>
                  </div>
            ...
            <div id="esenciales">
              ...
              >
                <p className="mb-4">
                  ...
                  funcionamiento de nuestra web. Sin ellas, no podríamos
                  ofrecerte ciertos servicios básicos como la gestión del
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      ...
                      <tr>
                        ...
                        <td className="p-3">
                          Recuerda los productos en tu carrito
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="p-3">
                          Guarda tus preferencias de cookies
                        </td>
                ...
                <div className="mt-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                  <p className="text-sm text-green-800">
                    <strong>Nota:</strong> Estas cookies no requieren tu
                    consentimiento según la normativa vigente, ya que son
                    imprescindibles para el funcionamiento del sitio. No puedes
                    desactivarlas desde nuestra página de configuración, pero
                    puedes hacerlo desde la configuración de tu navegador
                    (aunque esto puede afectar al funcionamiento de la web).
                  </p>
                </div>
              </CookieSection>
            </div>
            ...
            <div id="analiticas">
              ...
              >
                <p className="mb-4">
                  Las cookies analíticas nos permiten analizar cómo los usuarios
                  interactúan con nuestra web, identificando qué páginas son más
                  visitadas, cuánto tiempo pasan los usuarios en cada sección y
                  detectando posibles errores. Esta información es anónima y nos
                  ayuda a mejorar continuamente nuestros servicios.
                </p>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      <tr>
                        ...
                        <td className="p-3">
                          Distingue usuarios únicos (Google Analytics)
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="p-3">
                          Distingue usuarios (Google Analytics)
                        </td>
                ...
                <div className="mt-4 p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                  <p className="text-sm text-yellow-800">
                    <strong>Requiere consentimiento:</strong> Estas cookies
                    requieren tu consentimiento previo. Puedes aceptarlas o
                    rechazarlas mediante nuestro banner de cookies o desde la
            ...
            <div id="marketing">
              ...
              >
                <p className="mb-4">
                  Estas cookies se utilizan para rastrear a los visitantes en
                  nuestra web y mostrar anuncios personalizados en otras
                  plataformas. También nos ayudan a medir la eficacia de
                  nuestras campañas publicitarias y a comprender qué productos
                  pueden interesarte más.
                </p>
                ...
                <div className="mt-4 flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">
                    Actualmente no utilizamos cookies de marketing activamente.
                    Si en el futuro decidimos implementar publicidad
                    personalizada, actualizaremos esta política y solicitaremos
            ...
            <div id="gestion">
              ...
              >
                <p className="mb-4">
                  ...
                  Puedes gestionar tus preferencias de varias formas:
                </p>

                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Desde nuestro banner de cookies
                </h3>
                <p className="mb-4">
                  Al acceder a nuestra web por primera vez, verás un banner
                  donde podrás:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
                  <li>
                    <strong>Aceptar todas:</strong> Consientes el uso de todas
                    las cookies.
                  </li>
                  <li>
                    <strong>Configurar preferencias:</strong> Seleccionas qué
                    tipos de cookies aceptas.
                  </li>
                  <li>
                    <strong>Rechazar todas:</strong> Solo se utilizarán las
                    cookies esenciales.
                  </li>
                </ul>
                ...
                <p className="mb-4">
                  ...
                  eliminar cookies. Consulta la document oficial de cada
                  navegador:
                </p>
                ...
                <div className="mt-6 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <p className="text-sm text-red-800">
                    <strong>Advertencia:</strong> Bloquear todas las cookies
                    puede afectar negativamente a la funcionalidad de muchos
                    sitios web, incluido el nuestro. Te recomendamos mantener
            ...
            <div id="terceros">
              ...
              >
                <p className="mb-4">
                  En nuestra web utilizamos servicios de terceros que también
                  pueden instalar cookies en tu dispositivo. Estos proveedores
                  tienen sus propias políticas de privacidad y cookies, que te
            ...
            <div id="contacto">
              ...
              >
                <p className="mb-4">
                  ...
                  sobre cómo utilizamos tus datos, o si deseas ejercer tus
                  derechos de protección de datos (acceso, rectificación,
                  supresión, limitación, portabilidad u oposición), puedes
                  contactarnos:
                </p>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    CIF: B12345678
                    <br />
                    Dirección: Calle Admin 123, 08001 Barcelona, Barcelona,
                    España
                    <br />
            ...
            <div className="bg-gray-100 rounded-xl p-6 text-center">
              <p className="text-sm text-gray-600">
                Esta política de cookies se actualiza periódicamente para
                reflejar cambios en nuestras prácticas de cookies y en la
                normativa vigente. Te recomendamos revisarla ocasionalmente.
              </p>
              <p className="text-sm text-gray-500 mt-2">
                © {new Date().getFullYear()} 3D Print. Todos los derechos
                reservados.
              </p>
            </div>
          </div>
