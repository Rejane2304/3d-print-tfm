    ...
    <section className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="p-6 lg:p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center flex-shrink-0">{icon}</div>
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 3xl:px-20">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="px-3 py-1 bg-white/10 rounded-full text-sm font-medium">Legal</span>
            </div>

            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-4">Política de Cookies</h1>
            <p className="text-lg lg:text-xl text-white/80 leading-relaxed">
              Te informamos sobre qué son las cookies, qué tipos utilizamos en nuestra web y cómo puedes gestionarlas
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 3xl:px-20 py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* What are Cookies */}
            <div id="que-son">
              <CookieSection title="¿Qué son las Cookies?" icon={<Cookie className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Las cookies son pequeños archivos de texto que se almacenan en tu dispositivo (ordenador, tablet,
                  móvil o cualquier otro dispositivo) cuando visitas una página web. Estos archivos permiten que el
                  sitio web recuerde información sobre tu visita, como tu idioma preferido, las opciones de
                  configuración seleccionadas y otros datos que facilitan tu navegación y hacen que la experiencia sea
                  más eficiente.
                </p>
                <p className="mb-4">
                  Las cookies desempeñan un papel muy importante, ya que mejoran la experiencia de navegación y ayudan a
                  que los sitios web funcionen de manera más eficiente. También proporcionan información valiosa a los
                  propietarios de los sitios web para mejorar sus servicios y ofrecer una experiencia más personalizada.
                </p>
                <div className="bg-indigo-50 rounded-lg p-4 border-l-4 border-indigo-500">
                  <p className="text-sm text-indigo-800">
                    <strong>Importante:</strong> Las cookies no pueden dañar tu dispositivo y no contienen virus ni
                    malware. Tampoco almacenan información sensible como contraseñas o datos bancarios sin tu
            ...
            {/* Types of Cookies */}
            <div id="tipos">
              <CookieSection title="Tipos de Cookies que Utilizamos" icon={<Eye className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  En <strong>3D Print</strong> utilizamos diferentes tipos de cookies para mejorar tu experiencia de
                  navegación. A continuación te explicamos cada una de ellas:
                </p>
                  ...
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        <br />
                        <strong>Cookies persistentes:</strong> Permanecen en tu dispositivo hasta que caducan o las
                        eliminas manualmente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        <br />
                        <strong>Cookies de terceros:</strong> Instaladas por servicios externos que utilizamos
                        (análisis, pagos, etc.).
                      </p>
                    </div>
                  </div>
            ...
            {/* Essential Cookies */}
            <div id="esenciales">
              <CookieSection title="Cookies Esenciales" icon={<Shield className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Estas cookies son estrictamente necesarias para el funcionamiento de nuestra web. Sin ellas, no
                  podríamos ofrecerte ciertos servicios básicos como la gestión del carrito de compra, el inicio de
                  sesión o la navegación segura.
                </p>
                ...
                <div className="mt-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                  <p className="text-sm text-green-800">
                    <strong>Nota:</strong> Estas cookies no requieren tu consentimiento según la normativa vigente, ya
                    que son imprescindibles para el funcionamiento del sitio. No puedes desactivarlas desde nuestra
                    página de configuración, pero puedes hacerlo desde la configuración de tu navegador (aunque esto
            ...
            {/* Analytics Cookies */}
            <div id="analiticas">
              <CookieSection title="Cookies Analíticas" icon={<BarChart3 className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Las cookies analíticas nos permiten analizar cómo los usuarios interactúan con nuestra web,
                  identificando qué páginas son más visitadas, cuánto tiempo pasan los usuarios en cada sección y
                  detectando posibles errores. Esta información es anónima y nos ayuda a mejorar continuamente nuestros
                  servicios.
                </p>
                ...
                <div className="mt-4 p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                  <p className="text-sm text-yellow-800">
                    <strong>Requiere consentimiento:</strong> Estas cookies requieren tu consentimiento previo. Puedes
                    aceptarlas o rechazarlas mediante nuestro banner de cookies o desde la configuración de tu
                    navegador.
                  </p>
                </div>
              </CookieSection>
            ...
            {/* Marketing Cookies */}
            <div id="marketing">
              <CookieSection title="Cookies de Marketing" icon={<Megaphone className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Estas cookies se utilizan para rastrear a los visitantes en nuestra web y mostrar anuncios
                  personalizados en otras plataformas. También nos ayudan a medir la eficacia de nuestras campañas
                  publicitarias y a comprender qué productos pueden interesarte más.
                </p>
                ...
                <div className="mt-4 flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">
                    Actualmente no utilizamos cookies de marketing activamente. Si en el futuro decidimos implementar
                    publicidad personalizada, actualizaremos esta política y solicitaremos tu consentimiento expreso.
                  </p>
                </div>
              </CookieSection>
            </div>
            ...
            {/* Managing Cookies */}
            <div id="gestion">
              <CookieSection title="Gestión de Cookies" icon={<Settings className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Tienes derecho a decidir si aceptas o rechazas las cookies. Puedes gestionar tus preferencias de
                  varias formas:
                </p>

                <h3 className="text-lg font-semibold text-gray-900 mb-3">Desde nuestro banner de cookies</h3>
                <p className="mb-4">Al acceder a nuestra web por primera vez, verás un banner donde podrás:</p>
                <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
                  <li>
                    <strong>Aceptar todas:</strong> Consientes el uso de todas las cookies.
                  </li>
                  <li>
                    <strong>Configurar preferencias:</strong> Seleccionas qué tipos de cookies aceptas.
                  </li>
                  <li>
                    <strong>Rechazar todas:</strong> Solo se utilizarán las cookies esenciales.
                  </li>
                </ul>

                <h3 className="text-lg font-semibold text-gray-900 mb-3">Desde tu navegador</h3>
                <p className="mb-4">
                  También puedes configurar tu navegador para bloquear o eliminar cookies. Consulta la document oficial
                  de cada navegador:
                </p>
                ...
                <div className="mt-6 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <p className="text-sm text-red-800">
                    <strong>Advertencia:</strong> Bloquear todas las cookies puede afectar negativamente a la
                    funcionalidad de muchos sitios web, incluido el nuestro. Te recomendamos mantener activadas al menos
            ...
            {/* Third Party Cookies */}
            <div id="terceros">
              <CookieSection title="Cookies de Terceros" icon={<ExternalLink className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  En nuestra web utilizamos servicios de terceros que también pueden instalar cookies en tu dispositivo.
                  Estos proveedores tienen sus propias políticas de privacidad y cookies, que te recomendamos consultar:
                </p>
            ...
            {/* Contact */}
            <div id="contacto">
              <CookieSection title="Contacto y Más Información" icon={<Mail className="h-5 w-5 text-indigo-600" />}>
                <p className="mb-4">
                  Si tienes alguna pregunta sobre nuestra política de cookies, sobre cómo utilizamos tus datos, o si
                  deseas ejercer tus derechos de protección de datos (acceso, rectificación, supresión, limitación,
                  portabilidad u oposición), puedes contactarnos:
                </p>
            ...
            <div className="bg-gray-100 rounded-xl p-6 text-center">
              <p className="text-sm text-gray-600">
                Esta política de cookies se actualiza periódicamente para reflejar cambios en nuestras prácticas de
                cookies y en la normativa vigente. Te recomendamos revisarla ocasionalmente.
              </p>
