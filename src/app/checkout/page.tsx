            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 lg:sticky lg:top-24">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                <h4 className="font-semibold text-blue-900 mb-2 flex items-center gap-2">
                  ...
                  Datos de prueba - {paymentMethod === 'CARD' ? 'Stripe' : paymentMethod === 'PAYPAL' ? 'PayPal Sandbox' : 'Demo'}
                </h4>
                {paymentMethod === 'CARD' && (
                ...
                {paymentMethod === 'PAYPAL' && (
                  <div className="text-sm space-y-1">
                    <p className="font-mono text-gray-700">Usuario: <span className="text-blue-600 font-semibold">sb-rb3ao50452979@personal.example.com</span></p>
                    <p className="font-mono text-gray-700">Password: <span className="text-blue-600">Q+7&gt;jQ^8</span></p>
                  </div>
                )}
                {(paymentMethod === 'BIZUM' || paymentMethod === 'TRANSFER') && (
                  <p className="text-sm text-gray-700">Método de prueba - No requiere datos reales</p>
                )}
              </div>
