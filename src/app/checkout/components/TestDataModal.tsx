...
const testDataConfigs: Record<PaymentMethod, TestDataConfig> = {
    ...
    content: (
      <div className="text-sm space-y-2">
        <p className="font-mono text-gray-700">
          Número: <span className="text-indigo-600 font-semibold">4242 4242 4242 4242</span>
        </p>
        <p className="font-mono text-gray-700">
          Expira: <span className="text-indigo-600">12/30</span> | CVC: <span className="text-indigo-600">123</span>
        </p>
      </div>
    ),
  },
  PAYPAL: {
    ...
    content: (
      <div className="text-sm space-y-2">
        <p className="font-mono text-gray-700">
          Usuario: <span className="text-blue-600 font-semibold">sb-rb3ao50452979@personal.example.com</span>
        </p>
        <p className="font-mono text-gray-700">
  ...
  BIZUM: {
    ...
    content: (
      <p className="text-sm text-gray-700">Método de prueba - No requiere datos reales. Se simulará un pago exitoso.</p>
    ),
  },
  TRANSFER: {
    title: 'Datos de prueba - Demo',
...
export function TestDataDisplay({ paymentMethod }: Readonly<{ paymentMethod: PaymentMethod }>) {
  const configs: Record<PaymentMethod, { title: string; content: React.ReactNode }> = {
    CARD: {
      ...
      content: (
        <div className="text-sm space-y-1">
          <p className="font-mono text-gray-700">
            Número: <span className="text-blue-600 font-semibold">4242 4242 4242 4242</span>
          </p>
          <p className="font-mono text-gray-700">
            Expira: <span className="text-blue-600">12/30</span> | CVC: <span className="text-blue-600">123</span>
          </p>
        </div>
      ),
    },
    ...
    BIZUM: {
      title: 'Demo',
      content: <p className="text-sm text-gray-700">Método de prueba - No requiere datos reales</p>,
    },
    TRANSFER: {
      title: 'Demo',
      content: <p className="text-sm text-gray-700">Método de prueba - No requiere datos reales</p>,
