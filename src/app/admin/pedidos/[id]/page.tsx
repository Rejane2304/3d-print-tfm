...
export default function AdminPedidoDetallePage() {
  ...
  const cargarPedido = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/pedidos/${params.id}`);
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/admin/pedidos" className="text-indigo-600 hover:text-indigo-800 mt-2 inline-block">
            ← Volver a pedidos
          </Link>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {new Date(pedido.creadoEn).toLocaleDateString('es-ES')} - {new Date(pedido.creadoEn).toLocaleTimeString('es-ES')}
                </p>
              </div>
            </div>
                ...
                {pedido.items.map((item) => (
                  <div key={item.id} className="p-6 flex items-center gap-4">
                    ...
                    <div className="text-right">
                      <p className="font-medium text-gray-900">{Number(item.precio).toFixed(2)} €</p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  {pedido.codigoPostalEnvio} {pedido.ciudadEnvio}, {pedido.provinciaEnvio}
                </p>
