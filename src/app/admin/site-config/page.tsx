            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  {formErrors.cifNif && <p className="mt-1 text-sm text-red-600">{formErrors.cifNif}</p>}
                </div>
                ...
                <div>
                  ...
                  />
                  {formErrors.ciudadEmpresa && <p className="mt-1 text-sm text-red-600">{formErrors.ciudadEmpresa}</p>}
                </div>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {formErrors.emailEmpresa && <p className="mt-1 text-sm text-red-600">{formErrors.emailEmpresa}</p>}
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="max-w-xs">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={e => handleChange('ivaPorDefecto', Number.parseFloat(e.target.value) || 0)}
                    min={0}
                    max={100}
                    step={0.01}
                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 \
                ...
                {formErrors.ivaPorDefecto && <p className="mt-1 text-sm text-red-600">{formErrors.ivaPorDefecto}</p>}
                <p className="mt-1 text-sm text-gray-500">Se utilizará en el cálculo de totales en el checkout</p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              <div className="max-w-xs">
                ...
                <input
                  ...
                  onChange={e => handleChange('umbralStockBajo', Number.parseInt(e.target.value) || 0)}
                  min={1}
                  max={1000}
                  step={1}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 \
