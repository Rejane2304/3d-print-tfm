...
export default function NuevaZonaEnvioPage() {
  ...
  const validateForm = () => {
    ...
    if (formData.regions.length === 0) return 'Debe agregar al menos una región';
    if (formData.postalCodePrefixes.length === 0) return 'Debe agregar al menos un prefijo de código postal';
    if (formData.baseCost < 0) return 'El costo base no puede ser negativo';
    if (formData.estimatedDaysMin < 1) return 'Los días estimados mínimos deben ser al menos 1';
    if (formData.estimatedDaysMax < 1) return 'Los días estimados máximos deben ser al menos 1';
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Los prefijos se usan para determinar a qué zona pertenece un código postal. 
                  Ejemplo: &quot;28&quot; cubre todos los códigos que empiezan con 28 (28001, 28002, etc.)
                </p>
